...
DVP designed the earliest 2D polygon plotting functionality together with the initial scripts, and contributed to the image-to-polygon and the image-to-mesh pipelines. 
...
# Acknowledgements
We particularly thank Anders M Fjell and Kristine B Walhovd for insightful discussion and funding support and Ingle K Amlien for inspiration and code comments. 
We also thank John Muschelli for his initial improvements in the package code and preparing it for incorporation in neuroconductor (-@neuroconductor), and Richard Beare for submitting the first community created atlas, and providing helpful comments to the base code.

# Funding 
This work is funded by EU Horizon 2020 Grant 'Healthy minds 0-100 years: Optimising the use of European brain imaging cohorts (Lifebrain)', with grant agreement number 732592 and ERC Starting Grant schemes (grant agreements 283634, 725025 and 313440). 
