...
Hence, `ggseg` plots can be easily complemented with any of the available ggplot features and options. We recommend users to get familiarized with [ggplot2](https://ggplot2.tidyverse.org/) grammar. 
