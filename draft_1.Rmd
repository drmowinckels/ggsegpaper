...
To provide the option of viewing and printing the plots in 3-dimensional space, another function was created using [plotly](https://plotly-book.cpsievert.me/).
...
A lot of credit goes to A.M.Winkler and his [Brainder](https://brainder.org/) work, which supplied us with the first examples of going from Freesurfer `.srf`-files to `.ply`-files, and whose scripts massively aided us in making this work.
