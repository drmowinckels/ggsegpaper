...
orca(fig7l, file = "msc_ggseg_files/figure-latex/figure7l.pdf", format = "pdf")
orca(fig7m, file = "msc_ggseg_files/figure-latex/figure7m.pdf", format = "pdf")
orca(fig7r, file = "msc_ggseg_files/figure-latex/figure7r.pdf", format = "pdf")

include_graphics(c("msc_ggseg_files/figure-latex/figure7l.pdf",
                   "msc_ggseg_files/figure-latex/figure7m.pdf",
                   "msc_ggseg_files/figure-latex/figure7r.pdf"))
```
...
orca(fig8l, file = "msc_ggseg_files/figure-latex/figure8l.pdf", format = "pdf")
orca(fig8m, file = "msc_ggseg_files/figure-latex/figure8m.pdf", format = "pdf")
orca(fig8r, file = "msc_ggseg_files/figure-latex/figure8r.pdf", format = "pdf")

include_graphics(c(
  "msc_ggseg_files/figure-latex/figure8l.pdf",
  "msc_ggseg_files/figure-latex/figure8m.pdf",
  "msc_ggseg_files/figure-latex/figure8r.pdf"))
...
include_plotly(fig9, "msc_ggseg_files/figure-latex/figure9.pdf")
```
...
invisible(ggsave(filename = "msc_ggseg_files/figure-latex/figure10ab.pdf", 
                 plot = ggsegs_p, device = "pdf"))
orca(desterieux_p, file = "msc_ggseg_files/figure-latex/figure10c.pdf", format = "pdf")
orca(icbm_p, file = "msc_ggseg_files/figure-latex/figure10d.pdf", format = "pdf")

include_graphics(c(
  "msc_ggseg_files/figure-latex/figure10ab.pdf",
  "msc_ggseg_files/figure-latex/figure10c.pdf",
  "msc_ggseg_files/figure-latex/figure10d.pdf"
))
```
